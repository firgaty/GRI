...
// A graph on [0,..,n-1].
public class AdvancedGraph implements IGraph {
    int n, m;
    ...
    public AdvancedGraph(Edges edg, boolean symmetrize) {
        n = edg.n;
        m = edg.m;
    ...
    public int[] adjacencyList(int u) {
        int[] out = new int[degree(u)];
        System.arraycopy(adjacency, offset[u], out, 0, degree(u));
        return out;
    }
